...
public class MiddleBiTree implements BoundingTree {
    private final ArrayList<Triangle> triangles;
    private final Box3 boundingBox;
    private MiddleBiTree left;
    private MiddleBiTree right;
    private boolean hasChildren;

    public static MiddleBiTree create(ArrayList<Triangle> triangles, int treeDepth) {
        Vector[] bounds = getBounds(triangles);
        return new MiddleBiTree(triangles, new Box3(bounds[0], bounds[1]), 0, treeDepth);
    }
    ...
    private MiddleBiTree(ArrayList<Triangle> triangles, Box3 boundingBox, int depth, int treeDepth) {
        ...
        hasChildren = true;
        left = new MiddleBiTree(leftTs, leftBox, depth + 1, treeDepth);
        right = new MiddleBiTree(rightTs, rightBox, depth + 1, treeDepth);
    }
