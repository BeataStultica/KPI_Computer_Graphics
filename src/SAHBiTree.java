...
public class SAHBiTree implements BoundingTree {
    ...
    public static SAHBiTree create(ArrayList<Triangle> triangles, int treeDepth) {
        ...
        return new SAHBiTree(triangles, new Box3(bounds[0], bounds[1]), 0, treeDepth);
    }
    ...
    private SAHBiTree(ArrayList<Triangle> triangles, Box3 boundingBox, int depth, int treeDepth) {
